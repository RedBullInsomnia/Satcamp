    ...
    public partial class Window : Form
    {
        ...
        void _updateTimer_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            this.Invoke(new Action(() =>
            {
              ...
              // Update servo positions only if needed
              ...
              stabilizeCb.Checked = _service.GetStablizationActive();
              ...
              if (_servoDriver != null)
              {
                  ...
                  _service.SetServoPos(0, pitchTrackBar.Value);
                  }
                  ...
                  _service.SetServoPos(1, yawTrackBar.Value);
                  }
              }
